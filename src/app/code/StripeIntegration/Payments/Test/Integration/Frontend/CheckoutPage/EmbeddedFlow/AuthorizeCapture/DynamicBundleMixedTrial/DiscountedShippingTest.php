...
class DiscountedShippingTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDynamicBundleMixedTrialCart()
    {
        ...
        $this->assertEquals(5, $trialSubscriptionsConfig["discount_total"], "Discount");
        $this->assertEquals(5, $trialSubscriptionsConfig["base_discount_total"], "Base Discount");

        // 2 bundle products x $1.65 (8.25% tax on $40)
        $this->assertEquals(2.98, $trialSubscriptionsConfig["tax_total"], "Tax");
        $this->assertEquals(2.98, $trialSubscriptionsConfig["tax_total"], "Base Tax");
